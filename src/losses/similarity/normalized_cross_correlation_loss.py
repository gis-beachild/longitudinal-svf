# Forked from https://github.com/BailiangJ/pytorch_similarity/blob/master/torch_similarity/modules/normalized_cross_correlation_loss.py
from __future__ import absolute_import

from src.losses.similarity.normalized_cross_correlation import NormalizedCrossCorrelation
