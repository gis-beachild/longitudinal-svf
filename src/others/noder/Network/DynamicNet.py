...
class DynamicNet(nn.Module):
    def __init__(self, img_sz, smoothing_kernel, smoothing_win, smoothing_pass, ds, bs):
        ...
        self.lin_shape = 64 * math.ceil(img_sz[0] / pow(2, 6)) * math.ceil(img_sz[1] / pow(2, 6)) * math.ceil(img_sz[2] / pow(2, 6))

        #emd修改后对应的linear层维度变化
        #self.lin1 = nn.Linear(864, self.bs, bias=bias)
        self.lin1 = nn.Linear(self.lin_shape, self.bs, bias=bias)
